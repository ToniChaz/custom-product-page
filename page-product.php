            ...
            <div id="left-col">
                ...
                <?php if (have_posts()) while (have_posts()) : the_post(); ?>
                    ...
                    <div class="post-entry">
                        ...
                        <div id="tabs">
                            <ul>
                                <li><a href="#tabs-1">Descripcion del producto</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" readonly="readonly"
                                                       name="product_detail_table_key[$a]"
                                                       value="<?php echo $product_detail_table_key[$a]; ?>">
                                            </td>
                                            <td>
                                                <label for="product_detail_table_value">Value</label>
                                                <input type="text" readonly="readonly" class="small"
                                                       name="product_detail_table_value[]"
                                                       value="<?php echo $product_detail_table_value[$a]; ?>">
                                            </td>
                                            <td>
                                                <label for="product_detail_table_select">Select</label>
                                                <input type="text" readonly="readonly"
                                                       name="product_detail_table_select[]"
                                                       value="<?php echo $product_detail_table_select[$a]; ?>">
                                            </td>
                                            <td>
                                                <label for="product_detail_table_select2">Select2</label>
                                                <input type="text" readonly="readonly"
                                                       name="product_detail_table_select2[]"
                                                       value="<?php echo $product_detail_table_select2[$a]; ?>">
                                            </td>
                                            </p>
                                        </tr>
                                    <?php } ?>
