...
function product_add_meta_box() {
		...
		add_meta_box(
			'product_metabox',
			__( 'Ficha producto', 'product_textdomain' ),
	    ...
	    <p> 
		  ...
		  <p>(All acions apply only to entries with check marked check boxes only.)</p>
			...
			<table id="dataTable" class="form" border="1">
			 <tbody>
			 <?php foreach($product_detail_table_key as $a => $b){ ?>
				<tr>
					<td >
...
function init_product_template() {
    ...
    wp_enqueue_script('jquery-ui',"{$plugin_url}/custom-product-page/js/vendor/jquery-ui.min.js");
